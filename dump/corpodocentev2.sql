...
CREATE TABLE `descricao` (
  ...
  KEY `fk_descricao_1_idx` (`codigo`),
  CONSTRAINT `fk_descricao_1` FOREIGN KEY (`codigo`) REFERENCES `disciplinas` (`codigodisciplina`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2018-11-07 20:45:58
